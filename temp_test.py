# ==============================================================
#  JINNS 2-D Heat + Moving Gaussian – SINGLE & BATCH TEST
# ==============================================================
!pip install jax equinox jinns
import jax
...
print("u(x=0,y=0,t=0) :", u_single)  # proof 
...
print('single point test pass!!!')
# ------------------------------------------------------------------
# 4-b) Test PDE on BATCH
# ------------------------------------------------------------------
res_batch = pde.equation(u_batch_test, xt_batch, params)
print("PDE residual shape:", res_batch.shape)
print('batch point test pass!!!')
